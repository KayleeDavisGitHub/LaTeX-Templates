...
% User "wizard" -> Select list of commands for "quick Build   	to run" in this order: LaTeX, MakeIndex, 					PdfLatex(twice), View PDF.
% This will make your document, index, then run pdflatex twice (which does a lot of debugging) and then shows you the pdf.
\documentclass[12pt]{article}
\usepackage{makeidx} %This makes the pdf.
...
% some course notes utilizing index for quick reference.
