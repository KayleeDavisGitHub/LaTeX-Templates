...
%   User "wizard" -> Select list of commands for "quick Build to run" in this order: 
%      LaTeX, MakeIndex, PdfLatex(twice), View PDF.
...
% Section Formatting (Making things less wide and "stretchy")
\usepackage{siunitx}
